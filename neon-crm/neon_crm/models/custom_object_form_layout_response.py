...
T = TypeVar("T", bound="CustomObjectFormLayoutResponse")


@_attrs_define
class CustomObjectFormLayoutResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_object_form_layout_response = cls(
        ...
        custom_object_form_layout_response.additional_properties = d
        return custom_object_form_layout_response
