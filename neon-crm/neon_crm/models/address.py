...
from ..models.address_fax_type import AddressFaxType
from ..models.address_phone_1_type import AddressPhone1Type
from ..models.address_phone_2_type import AddressPhone2Type
from ..models.address_phone_3_type import AddressPhone3Type
...
class Address:
    ...
    Attributes:
        ...
        phone_1_type (Union[Unset, AddressPhone1Type]):
        phone2 (Union[Unset, str]):
        phone_2_type (Union[Unset, AddressPhone2Type]):
        phone3 (Union[Unset, str]):
        phone_3_type (Union[Unset, AddressPhone3Type]):
        fax (Union[Unset, str]):
        fax_type (Union[Unset, AddressFaxType]):
    """
    ...
    phone_1_type: Union[Unset, AddressPhone1Type] = UNSET
    phone2: Union[Unset, str] = UNSET
    phone_2_type: Union[Unset, AddressPhone2Type] = UNSET
    phone3: Union[Unset, str] = UNSET
    phone_3_type: Union[Unset, AddressPhone3Type] = UNSET
    fax: Union[Unset, str] = UNSET
    fax_type: Union[Unset, AddressFaxType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_phone_1_type, Unset):
            ...
            phone_1_type = AddressPhone1Type(_phone_1_type)
        ...
        if isinstance(_phone_2_type, Unset):
            ...
            phone_2_type = AddressPhone2Type(_phone_2_type)
        ...
        if isinstance(_phone_3_type, Unset):
            ...
            phone_3_type = AddressPhone3Type(_phone_3_type)
        ...
        if isinstance(_fax_type, Unset):
            ...
            fax_type = AddressFaxType(_fax_type)
