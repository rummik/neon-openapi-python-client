...
T = TypeVar("T", bound="VolunteerSearchParam")


@_attrs_define
class VolunteerSearchParam:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        volunteer_search_param.additional_properties = d
        return volunteer_search_param
