...
from ..models.custom_object_page_param_sort_direction import CustomObjectPageParamSortDirection
from ..types import UNSET, Unset

T = TypeVar("T", bound="CustomObjectPageParam")


@_attrs_define
class CustomObjectPageParam:
    """
    Attributes:
        current_page (Union[Unset, int]): Default value : 0
        page_size (Union[Unset, int]): Default value : 20
        sort_column (Union[Unset, str]):
        sort_direction (Union[Unset, CustomObjectPageParamSortDirection]):
    """

    current_page: Union[Unset, int] = UNSET
    page_size: Union[Unset, int] = UNSET
    sort_column: Union[Unset, str] = UNSET
    sort_direction: Union[Unset, CustomObjectPageParamSortDirection] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_sort_direction, Unset):
            ...
            sort_direction = CustomObjectPageParamSortDirection(_sort_direction)

        custom_object_page_param = cls(
        ...
        custom_object_page_param.additional_properties = d
        return custom_object_page_param
