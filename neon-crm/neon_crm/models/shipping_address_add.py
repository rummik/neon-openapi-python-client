...
from ..models.shipping_address_add_fax_type import ShippingAddressAddFaxType
from ..models.shipping_address_add_phone_1_type import ShippingAddressAddPhone1Type
from ..models.shipping_address_add_phone_2_type import ShippingAddressAddPhone2Type
from ..models.shipping_address_add_phone_3_type import ShippingAddressAddPhone3Type
...
T = TypeVar("T", bound="ShippingAddressAdd")


@_attrs_define
class ShippingAddressAdd:
    """
    Attributes:
        account_id (Union[Unset, str]):
        address_id (Union[Unset, str]):
        shipping_company_name (Union[Unset, str]):
        shipping_deliver_to (Union[Unset, str]):
        ...
        phone_1_type (Union[Unset, ShippingAddressAddPhone1Type]):
        phone2 (Union[Unset, str]):
        phone_2_type (Union[Unset, ShippingAddressAddPhone2Type]):
        phone3 (Union[Unset, str]):
        phone_3_type (Union[Unset, ShippingAddressAddPhone3Type]):
        fax (Union[Unset, str]):
        fax_type (Union[Unset, ShippingAddressAddFaxType]):
    """

    account_id: Union[Unset, str] = UNSET
    address_id: Union[Unset, str] = UNSET
    shipping_company_name: Union[Unset, str] = UNSET
    shipping_deliver_to: Union[Unset, str] = UNSET
    ...
    phone_1_type: Union[Unset, ShippingAddressAddPhone1Type] = UNSET
    phone2: Union[Unset, str] = UNSET
    phone_2_type: Union[Unset, ShippingAddressAddPhone2Type] = UNSET
    phone3: Union[Unset, str] = UNSET
    phone_3_type: Union[Unset, ShippingAddressAddPhone3Type] = UNSET
    fax: Union[Unset, str] = UNSET
    fax_type: Union[Unset, ShippingAddressAddFaxType] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if shipping_deliver_to is not UNSET:
            field_dict["shippingDeliverTo"] = shipping_deliver_to
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        shipping_deliver_to = d.pop("shippingDeliverTo", UNSET)
        ...
        if isinstance(_phone_1_type, Unset):
            ...
            phone_1_type = ShippingAddressAddPhone1Type(_phone_1_type)
        ...
        if isinstance(_phone_2_type, Unset):
            ...
            phone_2_type = ShippingAddressAddPhone2Type(_phone_2_type)
        ...
        if isinstance(_phone_3_type, Unset):
            ...
            phone_3_type = ShippingAddressAddPhone3Type(_phone_3_type)
        ...
        if isinstance(_fax_type, Unset):
            ...
            fax_type = ShippingAddressAddFaxType(_fax_type)

        shipping_address_add = cls(
        ...
        shipping_address_add.additional_properties = d
        return shipping_address_add
