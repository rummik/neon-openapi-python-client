...
T = TypeVar("T", bound="CustomObjectValidatorRuleResponse")


@_attrs_define
class CustomObjectValidatorRuleResponse:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_object_validator_rule_response = cls(
            id=id,
        ...
        custom_object_validator_rule_response.additional_properties = d
        return custom_object_validator_rule_response
