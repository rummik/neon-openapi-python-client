...
T = TypeVar("T", bound="CreditCardOfflinePayment")


@_attrs_define
class CreditCardOfflinePayment:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        credit_card_offline_payment = cls(
        ...
        credit_card_offline_payment.additional_properties = d
        return credit_card_offline_payment
