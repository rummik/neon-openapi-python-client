...
T = TypeVar("T", bound="CustomObjectRelationListResponse")


@_attrs_define
class CustomObjectRelationListResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_object_relation_list_response = cls(
            custom_object_relation=custom_object_relation,
        )

        custom_object_relation_list_response.additional_properties = d
        return custom_object_relation_list_response
