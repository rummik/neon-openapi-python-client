...
from ..models.base_membership_change_type import BaseMembershipChangeType
from ..models.base_membership_enroll_type import BaseMembershipEnrollType
from ..models.base_membership_status import BaseMembershipStatus
from ..models.base_membership_term_unit import BaseMembershipTermUnit
...
T = TypeVar("T", bound="BaseMembership")
...
class BaseMembership:
    ...
    Attributes:
        ...
        change_type (Union[Unset, BaseMembershipChangeType]):
        term_unit (Union[Unset, BaseMembershipTermUnit]):
        term_duration (Union[Unset, int]):
        enroll_type (Union[Unset, BaseMembershipEnrollType]):
        ...
        status (Union[Unset, BaseMembershipStatus]):
    ...
    change_type: Union[Unset, BaseMembershipChangeType] = UNSET
    term_unit: Union[Unset, BaseMembershipTermUnit] = UNSET
    term_duration: Union[Unset, int] = UNSET
    enroll_type: Union[Unset, BaseMembershipEnrollType] = UNSET
    ...
    status: Union[Unset, BaseMembershipStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_change_type, Unset):
            ...
            change_type = BaseMembershipChangeType(_change_type)
        ...
        if isinstance(_term_unit, Unset):
            ...
            term_unit = BaseMembershipTermUnit(_term_unit)
        ...
        if isinstance(_enroll_type, Unset):
            ...
            enroll_type = BaseMembershipEnrollType(_enroll_type)
        ...
        if isinstance(_status, Unset):
            ...
            status = BaseMembershipStatus(_status)
        ...
        base_membership.additional_properties = d
