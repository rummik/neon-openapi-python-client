...
T = TypeVar("T", bound="ListRecordResponse")


@_attrs_define
class ListRecordResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_record_response = cls(
            record_data=record_data,
        )

        list_record_response.additional_properties = d
        return list_record_response
