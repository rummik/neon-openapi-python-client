...
from ..models.order_response_status import OrderResponseStatus
...
class OrderResponse:
    ...
    Attributes:
        ...
        status (Union[Unset, OrderResponseStatus]):
        payment_response (Union[Unset, PaymentResponse]):
    """

    id: Union[Unset, str] = UNSET
    account_id: Union[Unset, str] = UNSET
    status: Union[Unset, OrderResponseStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = OrderResponseStatus(_status)
