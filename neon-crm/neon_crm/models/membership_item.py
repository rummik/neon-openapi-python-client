...
from ..models.membership_item_change_type import MembershipItemChangeType
from ..models.membership_item_enroll_type import MembershipItemEnrollType
from ..models.membership_item_status import MembershipItemStatus
from ..models.membership_item_term_unit import MembershipItemTermUnit
...
T = TypeVar("T", bound="MembershipItem")
...
class MembershipItem:
    ...
    Attributes:
        ...
        change_type (Union[Unset, MembershipItemChangeType]):
        term_unit (Union[Unset, MembershipItemTermUnit]):
        term_duration (Union[Unset, int]):
        enroll_type (Union[Unset, MembershipItemEnrollType]):
        ...
        status (Union[Unset, MembershipItemStatus]):
    ...
    change_type: Union[Unset, MembershipItemChangeType] = UNSET
    term_unit: Union[Unset, MembershipItemTermUnit] = UNSET
    term_duration: Union[Unset, int] = UNSET
    enroll_type: Union[Unset, MembershipItemEnrollType] = UNSET
    ...
    status: Union[Unset, MembershipItemStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_change_type, Unset):
            ...
            change_type = MembershipItemChangeType(_change_type)
        ...
        if isinstance(_term_unit, Unset):
            ...
            term_unit = MembershipItemTermUnit(_term_unit)
        ...
        if isinstance(_enroll_type, Unset):
            ...
            enroll_type = MembershipItemEnrollType(_enroll_type)
        ...
        if isinstance(_status, Unset):
            ...
            status = MembershipItemStatus(_status)
        ...
        membership_item.additional_properties = d
