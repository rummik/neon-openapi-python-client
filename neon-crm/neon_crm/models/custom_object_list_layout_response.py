...
T = TypeVar("T", bound="CustomObjectListLayoutResponse")


@_attrs_define
class CustomObjectListLayoutResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_object_list_layout_response = cls(
        ...
        custom_object_list_layout_response.additional_properties = d
        return custom_object_list_layout_response
