...
from ..models.custom_object_field_field_data_type import CustomObjectFieldFieldDataType
...
T = TypeVar("T", bound="CustomObjectField")
...
class CustomObjectField:
    ...
    Attributes:
        ...
        field_data_type (Union[Unset, CustomObjectFieldFieldDataType]):
    ...
    field_data_type: Union[Unset, CustomObjectFieldFieldDataType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_data_type, Unset):
            ...
            field_data_type = CustomObjectFieldFieldDataType(_field_data_type)
        ...
        custom_object_field.additional_properties = d
