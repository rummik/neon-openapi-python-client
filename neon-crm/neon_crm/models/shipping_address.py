...
from ..models.shipping_address_fax_type import ShippingAddressFaxType
from ..models.shipping_address_phone_1_type import ShippingAddressPhone1Type
from ..models.shipping_address_phone_2_type import ShippingAddressPhone2Type
from ..models.shipping_address_phone_3_type import ShippingAddressPhone3Type
...
class ShippingAddress:
    ...
    Attributes:
        ...
        phone_1_type (Union[Unset, ShippingAddressPhone1Type]):
        phone2 (Union[Unset, str]):
        phone_2_type (Union[Unset, ShippingAddressPhone2Type]):
        phone3 (Union[Unset, str]):
        phone_3_type (Union[Unset, ShippingAddressPhone3Type]):
        fax (Union[Unset, str]):
        fax_type (Union[Unset, ShippingAddressFaxType]):
    """
    ...
    phone_1_type: Union[Unset, ShippingAddressPhone1Type] = UNSET
    phone2: Union[Unset, str] = UNSET
    phone_2_type: Union[Unset, ShippingAddressPhone2Type] = UNSET
    phone3: Union[Unset, str] = UNSET
    phone_3_type: Union[Unset, ShippingAddressPhone3Type] = UNSET
    fax: Union[Unset, str] = UNSET
    fax_type: Union[Unset, ShippingAddressFaxType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_phone_1_type, Unset):
            ...
            phone_1_type = ShippingAddressPhone1Type(_phone_1_type)
        ...
        if isinstance(_phone_2_type, Unset):
            ...
            phone_2_type = ShippingAddressPhone2Type(_phone_2_type)
        ...
        if isinstance(_phone_3_type, Unset):
            ...
            phone_3_type = ShippingAddressPhone3Type(_phone_3_type)
        ...
        if isinstance(_fax_type, Unset):
            ...
            fax_type = ShippingAddressFaxType(_fax_type)
