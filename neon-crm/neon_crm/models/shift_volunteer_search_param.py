...
T = TypeVar("T", bound="ShiftVolunteerSearchParam")


@_attrs_define
class ShiftVolunteerSearchParam:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        shift_volunteer_search_param = cls(
            page_size=page_size,
        ...
        shift_volunteer_search_param.additional_properties = d
        return shift_volunteer_search_param
