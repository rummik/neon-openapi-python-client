...
from ..models.donation_response_status import DonationResponseStatus
...
T = TypeVar("T", bound="DonationResponse")
...
class DonationResponse:
    ...
    Attributes:
        ...
        status (Union[Unset, DonationResponseStatus]):
        payment_response (Union[Unset, PaymentResponse]):
    """

    id: Union[Unset, str] = UNSET
    account_id: Union[Unset, str] = UNSET
    status: Union[Unset, DonationResponseStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = DonationResponseStatus(_status)
        ...
        donation_response.additional_properties = d
