...
from ...models.custom_object_relation_list_response import CustomObjectRelationListResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/customObjects/{api_alias}/relations",
    }
...
) -> Optional[Union[CustomObjectRelationListResponse, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = CustomObjectRelationListResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CustomObjectRelationListResponse, list["APIMessage"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get a list of custom object relations
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CustomObjectRelationListResponse, list['APIMessage']]
    """
