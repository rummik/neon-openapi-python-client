...
from ...models.time_sheet_search_param import TimeSheetSearchParam
from ...models.time_sheet_search_result import TimeSheetSearchResult
from ...types import UNSET, Response


def _get_kwargs(
    *,
    search_param: "TimeSheetSearchParam",
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[TimeSheetSearchResult, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = TimeSheetSearchResult.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[TimeSheetSearchResult, list["APIMessage"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[TimeSheetSearchResult, list['APIMessage']]
    """
