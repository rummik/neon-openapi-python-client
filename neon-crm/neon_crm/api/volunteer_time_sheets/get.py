...
) -> Optional[Union[TimeSheetApi, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = TimeSheetApi.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[TimeSheetApi, list["APIMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[TimeSheetApi, list['APIMessage']]
    """
