...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/grants/search/searchFields",
        "params": params,
    }
...
) -> Optional[Union[SearchFields, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = SearchFields.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[SearchFields, list["APIMessage"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[SearchFields, list['APIMessage']]
    """
