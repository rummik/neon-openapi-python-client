...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/grants/search/outputFields",
        "params": params,
    }
...
) -> Optional[Union[OutputFields, list["APIMessage"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OutputFields, list["APIMessage"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[OutputFields, list['APIMessage']]
    """
