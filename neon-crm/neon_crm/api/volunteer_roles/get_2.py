...
) -> Optional[Union[VolunteerRoleApi, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = VolunteerRoleApi.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[VolunteerRoleApi, list["APIMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[VolunteerRoleApi, list['APIMessage']]
    """
