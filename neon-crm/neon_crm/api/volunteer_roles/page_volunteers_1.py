...
from ...models.role_volunteer_search_param import RoleVolunteerSearchParam
...
def _get_kwargs(
    id: str,
    *,
    volunteer_search_param: "RoleVolunteerSearchParam",
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    ...
    *,
    ...
    """Get a list of volunteers assigned to a role
