...
from ...models.volunteer_role_search_param import VolunteerRoleSearchParam
from ...models.volunteer_role_search_result import VolunteerRoleSearchResult
from ...types import UNSET, Response


def _get_kwargs(
    *,
    search_param: "VolunteerRoleSearchParam",
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[VolunteerRoleSearchResult, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = VolunteerRoleSearchResult.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[VolunteerRoleSearchResult, list["APIMessage"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[VolunteerRoleSearchResult, list['APIMessage']]
    """
