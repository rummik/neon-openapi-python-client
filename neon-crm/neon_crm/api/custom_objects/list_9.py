...
from ...models.pagination_response_custom_object_response import PaginationResponseCustomObjectResponse
from ...types import UNSET, Response


def _get_kwargs(
    *,
    custom_object_page: "PageParam",
) -> dict[str, Any]:
    params: dict[str, Any] = {}

    json_custom_object_page = custom_object_page.to_dict()
    params.update(json_custom_object_page)
...
) -> Optional[Union[PaginationResponseCustomObjectResponse, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = PaginationResponseCustomObjectResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[PaginationResponseCustomObjectResponse, list["APIMessage"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    kwargs = _get_kwargs(
        custom_object_page=custom_object_page,
    )
...
def sync(
    *,
    ...
    Returns:
        Union[PaginationResponseCustomObjectResponse, list['APIMessage']]
    """
