...
from ...models.custom_object_email_notification import CustomObjectEmailNotification
...
def _get_kwargs(
    id_or_api_alias: str,
    *,
    body: CustomObjectEmailNotification,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/customObjects/{id_or_api_alias}/emailNotifications",
    }
...
) -> Optional[Union[CustomObjectEmailNotification, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = CustomObjectEmailNotification.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CustomObjectEmailNotification, list["APIMessage"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update the custom object email notification type
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CustomObjectEmailNotification, list['APIMessage']]
    """
