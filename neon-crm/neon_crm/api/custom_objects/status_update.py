...
from ...models.custom_object_status import CustomObjectStatus
...
def _get_kwargs(
    id_or_api_alias: str,
    *,
    body: CustomObjectStatus,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/customObjects/{id_or_api_alias}/updateStatus",
    }
...
) -> Optional[Union[CustomObjectResponse, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = CustomObjectResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CustomObjectResponse, list["APIMessage"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update a custom object's status
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CustomObjectResponse, list['APIMessage']]
    """
