...
from ...models.pagination_response_list_record_response import PaginationResponseListRecordResponse
from ...models.record_search_param import RecordSearchParam
...
def _get_kwargs(
    id_or_api_alias: str,
    *,
    body: RecordSearchParam,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/customObjects/{id_or_api_alias}/records/list",
    }
...
) -> Optional[Union[PaginationResponseListRecordResponse, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = PaginationResponseListRecordResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[PaginationResponseListRecordResponse, list["APIMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[PaginationResponseListRecordResponse, list['APIMessage']]
    """
