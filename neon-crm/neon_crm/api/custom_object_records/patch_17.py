...
from ...models.custom_object_record import CustomObjectRecord
...
def _get_kwargs(
    ...
    id: str,
    *,
    body: CustomObjectRecord,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/customObjects/{id_or_api_alias}/records/{id}",
    }
...
) -> Optional[Union[RecordResponse, list["APIMessage"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RecordResponse, list["APIMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[RecordResponse, list['APIMessage']]
    """
