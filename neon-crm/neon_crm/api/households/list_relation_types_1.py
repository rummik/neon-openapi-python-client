...
from ...models.list_relation_types_1_relation_type_category import ListRelationTypes1RelationTypeCategory
from ...types import UNSET, Response


def _get_kwargs(
    *,
    relation_type_category: ListRelationTypes1RelationTypeCategory,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/households/listRelationTypes",
        "params": params,
    }
