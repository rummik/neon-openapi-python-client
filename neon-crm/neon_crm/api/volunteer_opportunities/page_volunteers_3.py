...
from ...models.opportunity_volunteer_search_param import OpportunityVolunteerSearchParam
...
def _get_kwargs(
    id: str,
    *,
    search_param: "OpportunityVolunteerSearchParam",
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/opportunities/{id}/volunteers",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get a list of volunteers assigned to a volunteer opportunity
