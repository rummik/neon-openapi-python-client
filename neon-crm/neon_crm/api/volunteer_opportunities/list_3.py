...
from ...models.opportunity_search_param import OpportunitySearchParam
from ...models.opportunity_search_result import OpportunitySearchResult
from ...types import UNSET, Response


def _get_kwargs(
    *,
    search_param: "OpportunitySearchParam",
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[OpportunitySearchResult, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = OpportunitySearchResult.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OpportunitySearchResult, list["APIMessage"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get a list of volunteer opportunities
...
def sync(
    *,
    ...
    Returns:
        Union[OpportunitySearchResult, list['APIMessage']]
    """
