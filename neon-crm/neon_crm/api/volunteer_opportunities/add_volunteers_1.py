...
from ...models.assignment_volunteers import AssignmentVolunteers
...
def _get_kwargs(
    id: str,
    *,
    body: AssignmentVolunteers,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/opportunities/{id}/addVolunteers",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Add volunteers to a volunteer opportunity
