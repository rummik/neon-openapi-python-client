...
) -> Optional[Union[Opportunity, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = Opportunity.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Opportunity, list["APIMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Opportunity, list['APIMessage']]
    """
