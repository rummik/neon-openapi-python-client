...
from ...models.group_volunteer_search_param import GroupVolunteerSearchParam
...
def _get_kwargs(
    id: str,
    *,
    volunteer_search_param: "GroupVolunteerSearchParam",
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    ...
    *,
    ...
    """Get a list of volunteers in a volunteer group
