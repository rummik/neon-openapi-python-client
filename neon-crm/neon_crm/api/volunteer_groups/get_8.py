...
) -> Optional[Union[UserGroupApi, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = UserGroupApi.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[UserGroupApi, list["APIMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[UserGroupApi, list['APIMessage']]
    """
