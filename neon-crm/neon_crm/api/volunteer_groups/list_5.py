...
from ...models.user_group_search_param import UserGroupSearchParam
from ...models.user_group_search_result import UserGroupSearchResult
from ...types import UNSET, Response


def _get_kwargs(
    *,
    search_param: "UserGroupSearchParam",
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[UserGroupSearchResult, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = UserGroupSearchResult.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[UserGroupSearchResult, list["APIMessage"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get a list of volunteer groups
...
def sync(
    *,
    ...
    Returns:
        Union[UserGroupSearchResult, list['APIMessage']]
    """
