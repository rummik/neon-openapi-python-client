...
from ...models.custom_object_list_layout_response import CustomObjectListLayoutResponse
...
) -> Optional[Union[CustomObjectListLayoutResponse, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = CustomObjectListLayoutResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CustomObjectListLayoutResponse, list["APIMessage"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get a custom object list layout
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CustomObjectListLayoutResponse, list['APIMessage']]
    """
