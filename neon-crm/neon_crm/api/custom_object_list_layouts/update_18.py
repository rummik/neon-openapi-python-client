...
from ...models.custom_object_list_layout import CustomObjectListLayout
from ...models.custom_object_list_layout_entry_response import CustomObjectListLayoutEntryResponse
...
def _get_kwargs(
    ...
    id: str,
    *,
    body: CustomObjectListLayout,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/customObjects/{api_alias}/listLayouts/{id}",
    }
...
) -> Optional[Union[CustomObjectListLayoutEntryResponse, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = CustomObjectListLayoutEntryResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CustomObjectListLayoutEntryResponse, list["APIMessage"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update a custom object list layout
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CustomObjectListLayoutEntryResponse, list['APIMessage']]
    """
