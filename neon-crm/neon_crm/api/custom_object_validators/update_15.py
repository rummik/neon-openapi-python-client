...
from ...models.custom_object_validator_rule import CustomObjectValidatorRule
...
def _get_kwargs(
    ...
    id: str,
    *,
    body: CustomObjectValidatorRule,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/customObjects/{id_or_api_alias}/validators/{id}",
    }
...
) -> Optional[Union[CustomObjectValidatorRuleResponse, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = CustomObjectValidatorRuleResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CustomObjectValidatorRuleResponse, list["APIMessage"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update a custom object validator
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CustomObjectValidatorRuleResponse, list['APIMessage']]
    """
