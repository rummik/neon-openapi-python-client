...
from ...models.volunteer_account_ids import VolunteerAccountIds
...
def _get_kwargs(
    ...
    id: str,
    *,
    body: VolunteerAccountIds,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/opportunities/{opportunity_id}/shifts/{id}/removeVolunteers",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Remove volunteers from a shift
