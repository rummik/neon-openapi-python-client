...
) -> Optional[Union[OpportunityShift, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = OpportunityShift.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OpportunityShift, list["APIMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[OpportunityShift, list['APIMessage']]
    """
