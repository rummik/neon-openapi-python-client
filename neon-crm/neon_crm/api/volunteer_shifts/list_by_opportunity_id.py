...
from ...models.opportunity_shift_search_param import OpportunityShiftSearchParam
from ...models.opportunity_shift_search_result import OpportunityShiftSearchResult
...
def _get_kwargs(
    opportunity_id: str,
    *,
    search_param: "OpportunityShiftSearchParam",
) -> dict[str, Any]:
    params: dict[str, Any] = {}

    json_search_param = search_param.to_dict()
    params.update(json_search_param)

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/opportunities/{opportunity_id}/shifts",
        "params": params,
    }
...
) -> Optional[Union[OpportunityShiftSearchResult, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = OpportunityShiftSearchResult.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OpportunityShiftSearchResult, list["APIMessage"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Gets a list of volunteer shifts for a volunteer opportunity
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[OpportunityShiftSearchResult, list['APIMessage']]
    """
