...
from ...models.custom_object_field_response import CustomObjectFieldResponse
from ...models.edit_custom_object_field import EditCustomObjectField
...
def _get_kwargs(
    ...
    field_alias: str,
    *,
    body: EditCustomObjectField,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/customObjects/{id_or_api_alias}/fields/{field_alias}",
    }
...
) -> Optional[Union[CustomObjectFieldResponse, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = CustomObjectFieldResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CustomObjectFieldResponse, list["APIMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CustomObjectFieldResponse, list['APIMessage']]
    """
