...
from ...models.pagination_response_custom_object_field_list_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/customObjects/{id_or_api_alias}/fields",
        "params": params,
    }
...
) -> Optional[Union[PaginationResponseCustomObjectFieldListResponse, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = PaginationResponseCustomObjectFieldListResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[PaginationResponseCustomObjectFieldListResponse, list["APIMessage"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get a list of custom object fields
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[PaginationResponseCustomObjectFieldListResponse, list['APIMessage']]
    """
