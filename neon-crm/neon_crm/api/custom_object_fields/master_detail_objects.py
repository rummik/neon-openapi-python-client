...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/customObjects/{id_or_api_alias}/masterDetailObjects",
    }
...
) -> Optional[Union[ListObjectsResponse, list["APIMessage"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ListObjectsResponse, list["APIMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ListObjectsResponse, list['APIMessage']]
    """
