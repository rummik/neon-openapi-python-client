...
from ...models.custom_object_form_layout import CustomObjectFormLayout
from ...models.custom_object_form_layout_entry_response import CustomObjectFormLayoutEntryResponse
...
def _get_kwargs(
    ...
    id: str,
    *,
    body: CustomObjectFormLayout,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/customObjects/{api_alias}/formLayouts/{id}",
    }
...
) -> Optional[Union[CustomObjectFormLayoutEntryResponse, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = CustomObjectFormLayoutEntryResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CustomObjectFormLayoutEntryResponse, list["APIMessage"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update a custom object form layout
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CustomObjectFormLayoutEntryResponse, list['APIMessage']]
    """
