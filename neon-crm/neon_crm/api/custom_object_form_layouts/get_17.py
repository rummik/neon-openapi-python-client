...
from ...models.custom_object_form_layout_response import CustomObjectFormLayoutResponse
...
) -> Optional[Union[CustomObjectFormLayoutResponse, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = CustomObjectFormLayoutResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CustomObjectFormLayoutResponse, list["APIMessage"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get a custom object form layout
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CustomObjectFormLayoutResponse, list['APIMessage']]
    """
