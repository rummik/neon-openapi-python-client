...
from ...models.pagination_response_custom_object_layout_page_item import PaginationResponseCustomObjectLayoutPageItem
...
def _get_kwargs(
    ...
    *,
    ...
    json_page_param = page_param.to_dict()
    params.update(json_page_param)

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/customObjects/{api_alias}/formLayouts",
        "params": params,
    }
...
) -> Optional[Union[PaginationResponseCustomObjectLayoutPageItem, list["APIMessage"]]]:
    if response.status_code == 200:
        response_200 = PaginationResponseCustomObjectLayoutPageItem.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[PaginationResponseCustomObjectLayoutPageItem, list["APIMessage"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get a list of custom object form layouts
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[PaginationResponseCustomObjectLayoutPageItem, list['APIMessage']]
    """
